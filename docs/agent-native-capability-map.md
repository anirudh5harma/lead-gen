...
| Track company | `/dashboard/profile#signal-setup`, `/dashboard/agent#opportunities` | `product.company.track` | `workspace.company.tracked` -> graph/source projection | Ready |
