        ...
        <div className="w-full max-w-7xl mx-auto flex items-center justify-between px-6 md:px-8 h-16">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6 text-[13px] text-[var(--color-text-2)]">
              <a href="#how" className="hover:text-[var(--color-text-1)] transition-colors">How it works</a>
              <a href="#features" className="hover:text-[var(--color-text-1)] transition-colors">Features</a>
      ...
      <footer className="relative z-10 border-t border-[var(--color-line-1)]">
        <div className="w-full max-w-7xl mx-auto px-6 md:px-8 py-8 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-[12px] text-[var(--color-text-3)]">
            ...
            <a href="#" className="hover:text-[var(--color-text-1)] transition-colors">Privacy</a>
            <a href="#" className="hover:text-[var(--color-text-1)] transition-colors">Terms</a>
            <a href="mailto:hello@bombsell.com" className="hover:text-[var(--color-text-1)] transition-colors">Contact</a>
          </div>
        </div>
      </footer>
    </div>
