-- ============================================================
-- 059_distribution_runtime_tables.sql
-- Dedicated forward migration for marketing distribution tables.
-- This repeats the runtime table definitions from 054 so production
-- databases that missed that migration can recover safely.
-- ============================================================
