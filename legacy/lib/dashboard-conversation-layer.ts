...
export async function classifyDashboardConversation(
  ...
  void transcript
  void context
  return { kind: 'unsupported', reason: 'Server-side dashboard conversation classification moved behind /api/voice/classify. Use classifyDashboardConversationClient in the dashboard.' }
}
