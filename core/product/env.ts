...
export const PRODUCT_ENV_VARS: readonly ProductEnvVar[] = [
  ...
  },
  {
    ...
    requirement: "optional",
    category: "runtime",
    description: "Fly.io API token used to authenticate the Fly worker deploy script. Falls back to flyctl auth when unset.",
  },
  {
    name: "FLY_CLI",
    requirement: "optional",
    category: "runtime",
    description: "Optional flyctl binary path override for the Fly worker deploy script. Defaults to ~/.fly/bin/flyctl or flyctl on PATH.",
  ...
  },
  {
    ...
    requirement: "optional",
    category: "runtime",
    description: "Fly config file used by the worker deploy script.",
    example: "fly.toml",
  },
  {
    name: "FLY_ORG",
  ...
  },
  {
    ...
    requirement: "optional",
    category: "runtime",
    description: "Fallback Fly.io organization slug for the worker deploy script when FLY_ORG is unset.",
  },
  {
    name: "FLY_WORKER_APP_NAME",
    requirement: "optional",
    category: "runtime",
    description: "Fly worker app name. Defaults to the app declared in FLY_CONFIG_FILE or bombsell-production-worker.",
    example: "bombsell-production-worker",
  },
  {
    ...
    requirement: "optional",
    category: "runtime",
    description: "Set to 1 for Fly smoke checks that should not prove or modify Restate production routing.",
    example: "0",
  },
  {
    ...
    requirement: "optional",
    category: "runtime",
    description: "Set to 1 for Fly smoke checks that should not run Restate runtime, outreach, or production app gates.",
    example: "0",
  },
  {
