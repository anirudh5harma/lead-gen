...
export function buildAssistantInstructions(): string {
  return [
    ...
    "Use metrics_get for governed metrics, entities_find or entities_get for graph lookups, signals_list for current qualified work, workspace_context or company_brain_recall for broader context, conversation_proof for exact thread evidence, and meeting_prep for source-backed prep.",
