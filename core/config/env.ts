...
export const ENVIRONMENT_KEYS: readonly EnvironmentKey[] = [
  ...
  { key: "NEATLOGS_WRITE_KEY", tier: "optional", purpose: "Optional ingest-only Neatlogs trace export key" },
  { key: "NEATLOGS_PROJECT", tier: "optional", purpose: "Neatlogs target project name" },
  { key: "NEATLOGS_ENDPOINT", tier: "optional", purpose: "Neatlogs ingest endpoint override" },
  { key: "NEATLOGS_FLUSH_DELAY_MS", tier: "optional", purpose: "Neatlogs trace batching delay" },
  { key: "NEATLOGS_TIMEOUT_MS", tier: "optional", purpose: "Neatlogs trace export timeout" },
