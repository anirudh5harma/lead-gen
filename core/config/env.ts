...
export const ENVIRONMENT_KEYS: readonly EnvironmentKey[] = [
  ...
  { key: "FLY_API_TOKEN", tier: "optional", purpose: "Fly.io API token for non-interactive flyctl auth in the worker deploy script" },
  { key: "FLY_CLI", tier: "optional", purpose: "flyctl binary path override for the Fly worker deploy script" },
  { key: "FLY_CONFIG_FILE", tier: "optional", purpose: "Fly.io app config file for the worker deploy script" },
  { key: "FLY_ORG", tier: "optional", purpose: "Fly.io organization slug for the worker app" },
  { key: "FLY_WORKER_ORG", tier: "optional", purpose: "Legacy fallback Fly.io organization slug for the worker app" },
  { key: "FLY_WORKER_APP_NAME", tier: "optional", purpose: "Fly.io app name for the managed background worker deploy" },
  { key: "FLY_SKIP_RESTATE_CUTOVER", tier: "optional", purpose: "Skip Restate URI verification for Fly cutover checks" },
  { key: "FLY_SKIP_RUNTIME_GATES", tier: "optional", purpose: "Skip runtime gates for Fly cutover checks" },
