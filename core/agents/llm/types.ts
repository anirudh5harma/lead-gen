/**
 * LLM client — provider-agnostic surface. Per ARCHITECTURE.md, DeepSeek V4
 * Pro is the single default model; this interface is the seam that keeps
 * "swap a provider" cheap when we want it.
 *
