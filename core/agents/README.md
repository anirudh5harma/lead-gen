...
1. **Users see Reps, not agents.** A Rep is the named persona (e.g., "Maya — outbound SDR for fintech founders"). Underneath, a Rep is composed of role agents (researcher, writer, sender, replier). Never expose raw agents to the user.
